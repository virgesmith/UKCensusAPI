...
class CensusAPI(ABC):
  ...
  DEFAULT_CACHE_DIR = Path.home() / ".cache/ukcensusapi"
  ...
  # @abstractmethod
  # def get_data(self, table: str, coverage: str, resolution: str, category_filters={}, r_compat: bool = False) -> pd.DataFrame:
  ...
  @abstractmethod
  def get_metadata(self, table_name: str, resolution: Optional[str]) -> dict[str, Any]:
    raise NotImplementedError()
